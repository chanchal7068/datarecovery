        ...
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <p className="text-slate-500 mb-4 leading-relaxed text-sm">
              Data Storage Solutions (DSS) is a leading Data Recovery Company based out of Bangalore. With more than 20 years of experience, DSS has made a mark as a reliable data recovery provider.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-100 transition-all duration-300">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">Our Company have core focus on Data Recovery Services. We have 20+ years of experience in data recovery, serving individuals, SME&apos;s, corporates &amp; Govt Organizations.</p>
            </div>
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-100 transition-all duration-300">
              <div className="w-8 h-1 bg-[#3da3ff] rounded mb-4"></div>
